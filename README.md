# Задание
В этом тестовом задании вам надо будет успешно решить задачу, а также прорешать опросник. Ссылка на опросник: questionary.odt.

Условие задачи вы найдете ниже.
